...
<html lang="en">
	<head>
		<title>Adventures of Superman: The Birthday Letter - Small Screen Superman</title>
		<?php
	...
	<body>
		...
		?>
		<main>
		<h1 id="beginning"><span class="seriesname">Adventures of Superman</span><br> Season 1 Episode 7: The Birthday Letter</h1>
		...
		<ul>
			<li><a href="http://www.imdb.com/title/tt0506600/" target="_blank">IMDb Page</li>
			<li><a href="http://www.jimnolt.com/BirthdayLetterReview.htm" target="_blank"><i>The Adventures Continue</i> Review by Bruce Dettman</li>
			<li><a href="https://www.supermanhomepage.com/tv/tv.php?topic=reviews/aos-ep007" target="_blank"><i>Superman Homepage</i> Review by James Lantz</li>
		</ul>
		</main>
