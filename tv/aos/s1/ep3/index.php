...
<html lang="en">
	<head>
		<title>The Adventures of Superman: The Case of the Talkative Dummy - Small Screen Superman</title>
		<?php
	...
	<body>
		...
		?>
		<main>
		<h1 id="beginning"><span class="seriesname">The Adventures of Superman</span><br> Season 1 Episode 3: The Case of the Talkative Dummy</h1>
		<img class="titlecard" src="">
		...
		<ul>
			<li><a href="http://www.imdb.com/title/tt0506604/" target="_blank">IMDb Page</li>
			<li><a href="http://www.jimnolt.com/TalkativeDummyReview.htm" target="_blank"><i>The Adventures Continue</i> Review by Bruce Dettman</li>
			<li><a href="https://www.supermanhomepage.com/tv/tv.php?topic=reviews/aos-ep003" target="_blank"><i>Superman Homepage</i> Review by James Lantz</li>
		</ul>
		</main>
